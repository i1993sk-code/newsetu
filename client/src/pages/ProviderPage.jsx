              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-700">{provider.address ? `${provider.address}, ` : ''}{provider.city}{provider.state ? `, ${provider.state}` : ''}{provider.pincode ? ` — ${provider.pincode}` : ''}</p>
                  </div>
                </div>
                {provider.experience && (
                  <div className="flex items-center gap-3">
