...
const catImg = {
  ...
  'Security Guard': 'https://images.pexels.com/photos/27299956/pexels-photo-27299956.jpeg?auto=compress&cs=tinysrgb&w=400',
...
export default function HomePage() {
  ...
  const hints = ['Plumber...', 'Electrician...', 'Painter...', 'Carpenter...', 'Tutor...', 'Mechanic...', 'AC Repair...', 'Cook...', 'Driver...', 'Maid...', 'Beautician...', 'Photographer...', 'Lawyer...', 'CA...'];
                  ...
                  return hasImg ? (
                    <button key={c._id} onClick={() => { setSearch(c.name); doSearch(c.name); }}
                      ...
                      <div className="relative h-28 sm:h-32">
                        <img src={catImg[c.name]} alt={c.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" loading="lazy" />
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
